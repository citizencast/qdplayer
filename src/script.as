...
private function xmlLoaded(e:Event):void
{
	...
	{
		videoDisplay.source = "rtmp://fms.flw.kernx.com/vids/" + sources.source[0].file;
...
public function playVideo(videoFile:String):void
{
	...
	videoDisplay.source = "rtmpt://fms.flw.kernx.com/vids/" + videoFile;
...
{
	e.currentTarget.setStyle('borderColor', 0x0099cc);
...
{
	e.currentTarget.setStyle('borderColor', (e.currentTarget.repeaterIndex + 4 * page == activeSequenceIndex) ? 0x0099cc : 0xFFFFFF);
